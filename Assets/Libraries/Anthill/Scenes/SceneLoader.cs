namespace Anthill.Scene
{
	...
	public class SceneLoader : MonoBehaviour
	{
		...
		{
			ADebug.Verbose($"Start loading `{aSceneName}` scene.", "SceneLoader");
			...
			ADebug.Verbose($"Scene `{aSceneName}` loaded in {_stopwatch.Elapsed.TotalMilliseconds} ms.", "SceneLoader");
		...
		{
			ADebug.Verbose($"Start unloading `{aSceneName}` scene.", "SceneLoader");
			...
			_stopwatch.Stop();
			ADebug.Verbose($"Scene `{aSceneName}` unloaded in {_stopwatch.Elapsed.TotalMilliseconds} ms.", "SceneLoader");

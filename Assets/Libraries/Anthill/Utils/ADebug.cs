...
public static class ADebug
{
	...
	/// </summary>
//#if UNITY_EDITOR
//	public static Verbosity verbosity = Verbosity.Verbose;
//#else
...
//#endif
	...
	/// </summary>
	public static Verbosity editorVerbosity = Verbosity.Verbose;
	...
	public static class Important
	{
		...
		public static void Log(object aMessage, object aSender = null, Object aContext = null, string aHexColor = null)
		{
			var result = ADebug.CompileMessage(1, false, LogKind.Normal, aSender, aMessage, false, aHexColor, false);
			if (result.success)
			{
				Debug.Log(result.message, aContext);
			}
		...
		public static void LogForce(object aMessage, object aSender = null, Object aContext = null, string aHexColor = null)
		{
			var result = ADebug.CompileMessage(1, false, LogKind.Normal, aSender, aMessage, false, aHexColor, true);
			if (result.success)
			{
				Debug.Log(result.message, aContext);
			}
		...
		{
			var result = ADebug.CompileMessage(0, false, LogKind.Normal, aSender, aMessage, false, aHexColor, false);
			if (result.success)
			{
				Debug.Log(result.message, aContext);
			}
		...
		{
			var result = ADebug.CompileMessage(0, false, LogKind.Normal, aSender, aMessage, false, aHexColor, true);
			if (result.success)
			{
				Debug.Log(result.message, aContext);
			}
	...
	public static class Editor
	{
		...
		public static void Log(object aMessage, object aSender = null, Object aContext = null, string aHexColor = null)
		{
			var result = ADebug.CompileMessage(-1, true, LogKind.Normal, aSender, aMessage, false, aHexColor, false);
			if (result.success)
			{
				Debug.Log(result.message, aContext);
			}
		...
		public static void LogForce(object aMessage, object aSender = null, Object aContext = null, string aHexColor = null)
		{
			var result = ADebug.CompileMessage(-1, true, LogKind.Normal, aSender, aMessage, false, aHexColor, true);
			if (result.success)
			{
				Debug.Log(result.message, aContext);
			}
		...
		{
			var result = ADebug.CompileMessage(-1, true, LogKind.Normal, aSender, aMessage, true, aHexColor, false);
			if (result.success)
			{
				Debug.Log(result.message, aContext);
			}
		...
		public static void Warning(object aMessage, object aSender = null, Object aContext = null)
		{
			var result = ADebug.CompileMessage(-1, true, LogKind.Warning, aSender, aMessage, false, null, false);
			if (result.success)
			{
				Debug.LogWarning(result.message, aContext);
			}
		...
		public static void Error(object aMessage, object aSender = null, Object aContext = null)
		{
			var result = ADebug.CompileMessage(-1, true, LogKind.Error, aSender, aMessage, false, null, false);
			if (result.success)
			{
				Debug.LogError(result.message, aContext);
			}

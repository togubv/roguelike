namespace Anthill.Utils
{
	...
	public static class AntPhysic
	{
		...
		{
			float impactVelocityX = aBody.linearVelocity.x;
			float impactVelocityY = aBody.linearVelocity.y;
			...
			{
				impactVelocityX -= aCollider.attachedRigidbody.linearVelocity.x;
				impactVelocityY -= aCollider.attachedRigidbody.linearVelocity.y;
